...
const DrillDownMap = () => {
    ...
    useLayoutEffect(() => {
        ...
        let labelContainer = chart.chartContainer.createChild(am4core.Container)
        labelContainer.hide()
        ...
        let globeIcon = labelContainer.createChild(am4core.Sprite)
        ...
        let globeHover = globeIcon.states.create('hover')
