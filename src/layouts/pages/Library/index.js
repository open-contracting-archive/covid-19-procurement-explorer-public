                                        ...
                                        <div
                                            ...
                                            <div className="card__caption">
                                                <Link to={`/resources/${resource.id}`}>
                                                    <h3 className="card__title mb-4 text-lg" style={{ maxHeight: '140px', overflow: 'hidden' }}>
                                                        {resource.title}
                                                    </h3>
                                                </Link>
                                                {get(resource, 'document.meta.download_url') ? (
                                                    <a href={get(resource, 'document.meta.download_url')}>
                                                        <div className="download flex">
                                                            ...
                                                            <span className="text-blue-20 test-sm ml-1">
                                                        {trans('Download')}
                                                    </span>
                                                        </div>
                                                    </a>
